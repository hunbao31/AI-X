...
export default function StudentClassesPage() {
  ...
  async function handleLeave(e: MouseEvent, classId: string) {
    e.preventDefault();
    e.stopPropagation();
    ...
    try {
      await apiPost(`/api/v1/classes/${classId}/leave`, {});
      load();
    } catch (err) {
      setLeaveError(err instanceof Error ? err.message : 'Không thể rời lớp học.');
    } finally {
      setLeavingId(null);
    }
  }
